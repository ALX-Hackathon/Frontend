...
const LandingNavbar = () => {
  ...
  const navbarClasses = `fixed  w-[95%] m-5 z-50 bg-white shadow-md  transition-all duration-300 ease-in-out ${
    isMobileMenuOpen ? "top-0" : "top-0 sm:top-0"
  } rounded-[40px]`;
    ...
    <nav className={navbarClasses}>
            ...
            <div className="hidden sm:ml-4 sm:flex sm:items-center">
              {user ? (
                <div className="flex items-center space-x-3">
                  <span className="text-xs hidden md:inline text-neutral-darker">
                    Welcome, {user.name}!
                  </span>
      ...
      >
        ...
        >
          <NavLink
            to="/"
            className="block px-3 py-2 rounded-md text-base font-medium text-neutral-darker hover:text-primary hover:bg-blue-50"
            end
            onClick={closeMobileMenu}
          >
            {" "}
          ...
          {user ? (
            <div className="px-1 py-2 space-y-2">
              <span className="text-sm text-neutral-darker block px-2">
