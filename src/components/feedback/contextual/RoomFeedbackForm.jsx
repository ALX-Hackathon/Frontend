  ...
  return (
    <Card title={`Room Feedback (${locationIdentifier})`}>
      <p className="text-sm text-neutral-dark mb-4">
        Please rate different aspects of your room.
      </p>
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        ...
        <StarRatingInputHelper
          name="roomNoise"
          control={control}
          label="Noise Level from outside/neighbors"
        />
        <StarRatingInputHelper
          name="bathroomCleanliness"
          control={control}
        ...
        <StarRatingInputHelper
          name="roomAmenities"
          control={control}
          label="In-Room Amenities (Coffee, TV, etc.)"
        />
        <Textarea
          id="roomComments"
        ...
        <fieldset className="border border-neutral-light p-3 rounded-md mt-2">
          <legend className="text-xs font-medium px-1 text-neutral-darker">
            Attach Photos (Optional Issue Report)
          </legend>
            ...
            {selectedFiles.map((file, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-error hover:text-red-700 flex-shrink-0"
                >
