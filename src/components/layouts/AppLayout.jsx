...
import Navbar from "../layouts/AppNavbar"; // Import Navbar
import Footer from "../layouts/AppFooter";
import AiChatbot from "../chatbot/AiChatbot"; // Import Chatbot component
...
const AppLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-light">
      ...
      {/* Footer */}
      <Footer />
      {/* Chatbot Container & Trigger */}
      <div className="fixed bottom-5 right-5 z-40 flex flex-col items-end">
        {/* Chatbot Window */}
        {showChatbot && (
          <div className="chatbot-container mb-2 shadow-xl rounded-lg overflow-hidden border border-neutral">
            {" "}
            {/* Custom class */}
